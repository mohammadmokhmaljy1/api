...
$router->add('/products/show/(\d+)', 'ProductController@show');
$router->add('/products/update/(\d+)', 'ProductController@update');
$router->add('/products/delete/(\d+)', 'ProductController@delete');
